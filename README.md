...
A cyberpunk-themed hackathon website for HackVerse 2026.

## 🎯 About

HackVerse is a 12-hour national-level hybrid hackathon featuring:
- **Date**: June 14, 2026
...
- **Hero Title Cycle**: Alternating title variations (HACKVERSE ↔ H4CKV3RS3)
...
- **Venue**: Announced Soon placeholder status card layout
